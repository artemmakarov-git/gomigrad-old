if SERVER then
local YOUR_VERSION = "1.08"
local PLY2 = "102"
local ADDON_NAME = "modelany"
local ADDON_ACTUAL_NAME = "ulx_set_model"
local DOWNLOAD_LINK = "http://goo.gl/S7YzZP"
local MESSAGE_TO_SERVER = "APPLE'S ULX SET MODEL ANY"
