if engine.ActiveGamemode() == "homigrad" then
	...
	CreateClientConVar("hg_bodycam2","0",true,false,nil,0,2)
	...
	local hg_bodycam2 = GetConVar("hg_bodycam2"):GetInt()
	
	
		if lply:InVehicle() or not firstPerson or hg_bodycam2 == 2 then return end
	
		if not lply:Alive() or (IsValid(wep) and whitelistweps[wep:GetClass()]) or lply:GetMoveType() == MOVETYPE_NOCLIP or hg_bodycam2 == 1 then
