...
--------------------------GMOD Settings--------------------------
xlib.makecheckbox{ x=10, y=10, label="Вкл.голос.чат", repconvar="rep_sv_voiceenable", parent=server }
xlib.makelabel{ x=10, y=33, label="Настройки:", parent=server }
xlib.makecombobox{ x=10, y=50, w=120, repconvar="rep_sv_alltalk", isNumberConvar=true, choices={ "Команда рядом с вами", "Только команда", "Все рядом с вами", "Слышно всех" }, parent=server }
...
server.catList:AddColumn( "Модуль серверной настройки" )
