...
xlib.makecheckbox{ x=10, y=10, label="Режим полета", repconvar="rep_sbox_noclip", parent=sbox_settings }
xlib.makecheckbox{ x=10, y=30, label="Бессмертие", repconvar="rep_sbox_godmode", parent=sbox_settings }
xlib.makecheckbox{ x=10, y=50, label="Урон от игроков", repconvar="rep_sbox_playershurtplayers", parent=sbox_settings }
xlib.makecheckbox{ x=10, y=70, label="Выдать оружие", repconvar="rep_sbox_weapons", parent=sbox_settings }
xlib.makecheckbox{ x=10, y=90, label="Огр. физ.ган", repconvar="rep_physgun_limited", parent=sbox_settings }

xlib.makecheckbox{ x=10, y=130, label="Сохр.пропы", repconvar="rep_sbox_persist", parent=sbox_settings }
