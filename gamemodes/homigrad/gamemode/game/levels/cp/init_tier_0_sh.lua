...
cp.red = {"Красные",Color(255,75,75),
    weapons = {"weapon_binokle","weapon_hg_flashbang","weapon_radio","weapon_gurkha","weapon_hands","med_band_big","med_band_small","medkit","painkiller","shina"},
    main_weapon = {"weapon_ak74u","weapon_akm","weapon_remington870","weapon_galil","weapon_rpk","weapon_galilsar","weapon_mp40","weapon_slb_g3sg1","weapon_slb_sg550","weapon_slb_awp" },
    secondary_weapon = {"weapon_p220","weapon_deagle","weapon_glock"},
    models = tdm.models
}

cp.blue = {"Синие",Color(75,75,255),
    weapons = {"weapon_binokle","weapon_hg_flashbang","weapon_radio","weapon_hands","weapon_kabar","med_band_big","med_band_small","medkit","painkiller","weapon_handcuffs","weapon_taser","shina"},
    main_weapon = {"weapon_mk18","weapon_m4a1","weapon_m3super","weapon_mp7","weapon_xm1014","weapon_fal","weapon_galilsar","weapon_m249","weapon_mp40","weapon_slb_awp","weapon_slb_sg552","weapon_slb_aug","weapon_slb_scout" },
